                ...
                ansiColor('xterm') {
                    ...
                    parallel (
                        linux_build: { 
                            ...
                            stage('Clone Code') {
                                branch = "4.2.0"
								sh "git clone --depth 1 -b ${branch} https://eranbibi:${GIT_PASS}@bitbucket.org/scalock/server.git ."
                                sh "git clone --depth 1 -b master https://eranbibi:${GIT_PASS}@bitbucket.org/scalock/devops.git"
